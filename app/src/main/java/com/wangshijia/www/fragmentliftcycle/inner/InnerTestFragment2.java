 ...
 */
public class InnerTestFragment2 extends LazyLoadBaseFragment {
    ...
    public InnerTestFragment2() {
        // Required empty public constructor
    }

    public static InnerTestFragment2 newInstance(String params) {
        InnerTestFragment2 fragment = new InnerTestFragment2();
