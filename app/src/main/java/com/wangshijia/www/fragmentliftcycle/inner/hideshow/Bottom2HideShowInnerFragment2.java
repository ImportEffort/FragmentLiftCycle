 ...
 */
public class Bottom2HideShowInnerFragment2 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom2HideShowInnerFragment2 newInstance(String params) {
        Bottom2HideShowInnerFragment2 fragment = new Bottom2HideShowInnerFragment2();
