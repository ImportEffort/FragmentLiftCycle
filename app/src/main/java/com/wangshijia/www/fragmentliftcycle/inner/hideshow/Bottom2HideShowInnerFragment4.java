package com.wangshijia.www.fragmentliftcycle.inner.hideshow;
 ...
 */
public class Bottom2HideShowInnerFragment4 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom2HideShowInnerFragment4 newInstance(String params) {
        Bottom2HideShowInnerFragment4 fragment = new Bottom2HideShowInnerFragment4();
