 ...
 */
public class InnerTestFragment1 extends LazyLoadBaseFragment {
    ...
    public InnerTestFragment1() {
        // Required empty public constructor
    }

    public static InnerTestFragment1 newInstance(String params) {
        InnerTestFragment1 fragment = new InnerTestFragment1();
