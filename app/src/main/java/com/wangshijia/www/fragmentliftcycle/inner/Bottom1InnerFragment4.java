 ...
 */
public class Bottom1InnerFragment4 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom1InnerFragment4 newInstance(String params) {
        Bottom1InnerFragment4 fragment = new Bottom1InnerFragment4();
