 ...
 */
public class Bottom2HideShowInnerFragment3 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom2HideShowInnerFragment3 newInstance(String params) {
        Bottom2HideShowInnerFragment3 fragment = new Bottom2HideShowInnerFragment3();
