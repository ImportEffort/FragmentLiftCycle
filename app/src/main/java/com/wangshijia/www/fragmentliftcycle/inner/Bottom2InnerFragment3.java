 ...
 */
public class Bottom2InnerFragment3 extends LazyLoadBaseFragment {


    private String text = getClass().getSimpleName() + " ";

    public static Bottom2InnerFragment3 newInstance(String params) {
        Bottom2InnerFragment3 fragment = new Bottom2InnerFragment3();
