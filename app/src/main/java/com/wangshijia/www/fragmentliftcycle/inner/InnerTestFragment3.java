 ...
 */
public class InnerTestFragment3 extends LazyLoadBaseFragment {
    ...
    public InnerTestFragment3() {
        // Required empty public constructor
    }

    public static InnerTestFragment3 newInstance(String params) {
        InnerTestFragment3 fragment = new InnerTestFragment3();
