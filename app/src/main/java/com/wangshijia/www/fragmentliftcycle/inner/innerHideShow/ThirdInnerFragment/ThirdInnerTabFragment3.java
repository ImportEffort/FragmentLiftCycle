...
public class ThirdInnerTabFragment3 extends LazyLoadBaseFragment {
    ...
    public ThirdInnerTabFragment3() {
        // Required empty public constructor
    }


    public static ThirdInnerTabFragment3 newInstance(String params) {
        ThirdInnerTabFragment3 fragment = new ThirdInnerTabFragment3();
