...
public class InnerHideShowTabFragment3 extends LazyLoadBaseFragment {
    ...
    public InnerHideShowTabFragment3() {
        // Required empty public constructor
    }


    public static InnerHideShowTabFragment3 newInstance(String params) {
        InnerHideShowTabFragment3 fragment = new InnerHideShowTabFragment3();
