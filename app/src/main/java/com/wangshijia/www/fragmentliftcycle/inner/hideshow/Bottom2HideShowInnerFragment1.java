 ...
 */
public class Bottom2HideShowInnerFragment1 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom2HideShowInnerFragment1 newInstance(String params) {
        Bottom2HideShowInnerFragment1 fragment = new Bottom2HideShowInnerFragment1();
