...
public class ThirdInnerTabFragment2 extends LazyLoadBaseFragment {
    ...
    public ThirdInnerTabFragment2() {
        // Required empty public constructor
    }


    public static ThirdInnerTabFragment2 newInstance(String params) {
        ThirdInnerTabFragment2 fragment = new ThirdInnerTabFragment2();
