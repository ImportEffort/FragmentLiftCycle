...
public class ThirdInnerTabFragment4 extends LazyLoadBaseFragment {
    ...
    public ThirdInnerTabFragment4() {
        // Required empty public constructor
    }


    public static ThirdInnerTabFragment4 newInstance(String params) {
        ThirdInnerTabFragment4 fragment = new ThirdInnerTabFragment4();
