 ...
 */
public class Bottom2InnerFragment4 extends LazyLoadBaseFragment {


    private String text = getClass().getSimpleName() + " ";

    public static Bottom2InnerFragment4 newInstance(String params) {
        Bottom2InnerFragment4 fragment = new Bottom2InnerFragment4();
