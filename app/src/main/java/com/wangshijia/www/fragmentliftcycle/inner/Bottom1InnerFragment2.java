 ...
 */
public class Bottom1InnerFragment2 extends LazyLoadBaseFragment {

    private String text = getClass().getSimpleName() + " ";

    public static Bottom1InnerFragment2 newInstance(String params) {
        Bottom1InnerFragment2 fragment = new Bottom1InnerFragment2();
