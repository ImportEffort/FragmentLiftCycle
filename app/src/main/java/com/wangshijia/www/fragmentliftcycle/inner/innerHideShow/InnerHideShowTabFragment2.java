...
public class InnerHideShowTabFragment2 extends LazyLoadBaseFragment {
    ...
    public InnerHideShowTabFragment2() {
        // Required empty public constructor
    }


    public static InnerHideShowTabFragment2 newInstance(String params) {
        InnerHideShowTabFragment2 fragment = new InnerHideShowTabFragment2();
