...
public class InnerHideShowTabFragment4 extends LazyLoadBaseFragment {
    ...
    public InnerHideShowTabFragment4() {
        // Required empty public constructor
    }


    public static InnerHideShowTabFragment4 newInstance(String params) {
        InnerHideShowTabFragment4 fragment = new InnerHideShowTabFragment4();
